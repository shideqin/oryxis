...
> このドキュメントは v0.13.0 以降の英語版 README の翻訳です（2026-08-10 同期）。
...
リティキーと直接通信）、ネイティブ Mosh クライアント、複数
ボールト、東アジアの曖昧幅（ambiguous width）オプション。コ
ミュニティ要望のサイドバー tmux セッションマネージャーとホス
トのツリービューは、本バージョンで出荷されました。
