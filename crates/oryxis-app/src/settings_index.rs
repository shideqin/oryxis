...
pub(crate) static SETTINGS_INDEX: &[SettingsIndexEntry] = &[
    ...
    e(S::Interface, "restore_tabs_connect", "restored tabs connect dial launch startup selected focus auto reconnect"),
    e(S::Interface, "restore_last_active_tab", "open active tab launch startup land resume where left"),
    ...
    e(S::Terminal, "terminal_link_confirm", "link url open browser confirm ask ctrl click"),
    e(S::Terminal, "terminal_link_tunnel", "link callback tunnel port forward oauth sso login redirect"),
