...
pub(super) fn lookup(key: &str) -> &'static str {
    match key {
        ...
        "cloud_aliyun_login_hint" => "Uses the aliyun CLI's own configuration. Run `aliyun configure` first.",
        "cloud_tencent_login_hint" => "Uses the tccli configuration. Run `tccli configure` first.",
        "cloud_cli_profile" => "CLI profile",
        "cloud_cli_profile_ph" => "default (optional)",
        "cloud_cli_profile_hint" => "Blank uses the CLI's default profile.",
        "cloud_cli_region" => "Region",
        "cloud_aliyun_region_ph" => "cn-hangzhou (optional)",
        "cloud_tencent_region_ph" => "ap-guangzhou (optional)",
        "cloud_cli_region_hint" => "Blank uses the region that profile is configured with.",
        "cloud_ack_clusters" => "ACK clusters",
        "cloud_tke_clusters" => "TKE clusters",
        "cloud_managed_cluster_add" => "Add",
        "cloud_managed_cluster_refresh" => "Refresh credentials",
        "cloud_managed_cluster_added" => "Cluster added as a Kubernetes account.",
        "cloud_managed_cluster_refreshed" => "Cluster credentials refreshed.",
        "cloud_managed_cluster_add_failed" => "Failed to add cluster",
        "cloud_managed_cluster_endpoint_note" => "Its kubeconfig points at the cluster's public endpoint; if kubectl cannot reach it, enable public access in the provider console.",
        "cloud_managed_cluster_intranet_note" => "Its kubeconfig points at a private address: kubectl reaches it only from inside the cluster's VPC.",
        ...
        "restored_tab_dormant_hint" => "from your last session, select to connect",
        "restored_tab_queued_hint" => "from your last session, connecting shortly",
        "restore_tabs_on_launch" => "Restore last session's tabs",
        "restore_tabs_on_launch_desc" => "Tabs that were open come back as placeholders. Pinned tabs come back either way.",
        "restore_tabs_connect" => "Restored tabs connect",
        "restore_tabs_connect_selected" => "When selected",
        "restore_tabs_connect_launch" => "At launch",
        "restore_tabs_connect_desc" => "At launch dials hosts and local shells one after another, in tab order, so any prompt comes one at a time. SFTP and cloud tabs still connect when selected.",
        "restore_last_active_tab" => "Open on the tab that was active",
        "restore_last_active_tab_desc" => "Lands on the tab you were on instead of Hosts. If restored tabs connect when selected, arriving there connects it.",
        ...
        "theme_tag_dark" => "Dark",
        "theme_tag_light" => "Light",
        "theme_tag_high_contrast" => "High contrast",
        "theme_tag_low_contrast" => "Low contrast",
        "theme_tag_warm" => "Warm",
        "theme_tag_cool" => "Cool",
        "theme_tag_vivid" => "Vivid",
        "theme_tag_muted" => "Muted",
        ...
        "confirm_close_session_tab" => "Ask before closing a tab or the app with a live session",
        ...
        "close_session_title" => "Close this session?",
        "close_session_body" => "You are about to close a live session to {name}. Closing the tab disconnects it.",
        "close_session_confirm" => "Close session",
        "close_window_title" => "Quit Oryxis?",
        "close_window_body" => "Oryxis will quit. Live sessions disconnected: {n}.",
        "close_window_confirm" => "Quit",
        "close_others_title" => "Close other tabs?",
        "close_others_body" => "Every other tab closes. Live sessions disconnected: {n}.",
        "close_others_confirm" => "Close other tabs",
        "close_all_title" => "Close all tabs?",
        "close_all_body" => "Every tab closes. Live sessions disconnected: {n}.",
        "close_all_confirm" => "Close all tabs",
        ...
        "command_history_export_title" => "Export command history",
        "command_log_folder_title" => "Command log folder",
        "import_ssh_config_title" => "Import SSH config",
        "import_sessions_folder_title" => "Import a sessions folder",
        "select_ssh_certificate_title" => "Select SSH certificate",
        "save_public_key_title" => "Save public key",
        "select_private_key_title" => "Select private key",
        ...
        "relay_deploy_button" => "Install on one of your hosts",
        "relay_deploy_intro" => "Oryxis connects to a host from your vault over SSH, installs the verified oryxis-relay binary as a systemd service with the domain and token above, and adopts the endpoint. Every command is shown before anything runs.",
        "relay_deploy_port" => "Relay port",
        "relay_deploy_caddy" => "TLS via Caddy on the host",
        "relay_deploy_caddy_hint" => "Caddy must already be installed there: the domain above gets a site block and a Let's Encrypt certificate, and the relay listens on localhost only.",
        "relay_deploy_http_warning" => "Plain HTTP: the relay itself answers on the port above and the access token crosses the network unencrypted. Put TLS in front when you can.",
        "relay_deploy_probe" => "Check host",
        "relay_deploy_review" => "Review & run",
        "relay_deploy_copy_script" => "Copy script",
        "relay_deploy_no_host" => "Pick a host first",
        "relay_deploy_no_domain" => "Type the domain above, or turn off TLS via Caddy",
        "relay_deploy_bad_port" => "The relay port must be between 1 and 65535",
        "relay_deploy_not_linux" => "Only Linux hosts are supported ({os})",
        "relay_deploy_no_asset" => "No relay build for this architecture ({arch})",
        "relay_deploy_not_systemd" => "The host has no systemd. Install the relay by hand from the server file above.",
        "relay_deploy_no_caddy" => "Caddy was not found on the host. Install it there first, or turn TLS via Caddy off.",
        "relay_deploy_no_release" => "No signed relay release is published for this platform yet",
        "relay_deploy_hostkey_hint" => "An unattended connection asks nothing: the host has to be reachable and its key already known. Connect to it once from a terminal tab first.",
        "relay_deploy_probe_ok" => "Host: {os}, logged in as {user}",
        "relay_deploy_asset_line" => "Relay {version} ({name})",
        "relay_deploy_existing" => "oryxis-relay is already installed there; it will be updated and restarted.",
        "relay_deploy_via_sudo" => "Privileged commands run through sudo.",
        "relay_deploy_need_sudo" => "Neither root nor passwordless sudo on this host. Copy the script and run it there yourself.",
        "relay_deploy_consent_title" => "Run on {host}?",
        "relay_deploy_consent_desc" => "These commands run on {host} as {user}, over the SSH connection just opened. Nothing has run yet.",
        "relay_deploy_run" => "Run on {host}",
        "relay_deploy_step_probe" => "Checking the host",
        "relay_deploy_step_download" => "Downloading and verifying the relay",
        "relay_deploy_step_upload" => "Uploading to the host",
        "relay_deploy_step_install" => "Installing the binary",
        "relay_deploy_step_service" => "Writing the service and starting it",
        "relay_deploy_step_caddy" => "Configuring Caddy",
        "relay_deploy_step_health" => "Health check",
        "relay_deploy_step_adopt" => "Adopting the endpoint",
        "relay_deploy_done" => "Relay installed and adopted: {url}",
        "relay_deploy_failed" => "Deploy failed at: {step}",
        ...
        "offline_mode_desc" => "Oryxis makes no request of its own: no update checks, no font or plugin downloads, not even the manual ones. What you configured yourself still travels: the hosts you connect to, your AI endpoint, your sync backend, your cloud accounts. Turn it off to get everything back; nothing is removed.",
        "offline_mode_mirror_superseded" => "The download mirror does not apply while offline mode is on.",
        "update_check_offline" => "Update checks are off: offline mode is on. Turn it off in Settings > Advanced to check again.",
        "cjk_font_offline" => "The font for this language is not downloaded and offline mode is on; text may show as boxes until it is off.",
        "font_pack_offline" => "The terminal font is not downloaded and offline mode is on; keeping the current font.",
        "plugin_err_offline" => "Offline mode is on, so plugins are not downloaded. Turn it off in Settings > Advanced.",
        "plugins_offline_banner" => "Offline mode is on: the plugin catalog and downloads are paused. Installed plugins keep working.",
        ...
        "update_ready" => "Oryxis {new} is downloaded and ready to install.",
        "update_ready_sessions" => "Restarting now closes {n} live sessions.",
        ...
        "move_n_to_group" => "Move {n} hosts to group…",
        "connect_n_hosts" => "Connect {n} hosts",
        "remove_n_hosts" => "Remove {n} hosts",
        "group_picker_root" => "Top level (no group)",
        ...
        "biometric_enroll_failed" => "Biometric unlock could not be enabled, so it stays off. Your master password still works.",
        "api_url" => "API URL",
        ...
        "monitor_dash_empty_live" => "No monitored host has an open session.",
        "monitor_dash_empty_live_hint" => "Open a terminal tab on a monitored host, or turn off the live-session filter in Settings.",
        ...
        "import_into_folder" => "Into folder:",
        ...
        "pane_end_action" => "When a pane's session ends",
        "pane_end_action_desc" => "What happens to a pane when its shell exits or its connection drops. A remote tab with only one pane keeps relabelling and reconnecting as before.",
        "pane_end_action_prompt" => "Keep the pane",
        "pane_end_action_close" => "Close the pane",
        "pane_ended" => "Session ended",
        "pane_ended_restart" => "Restart",
        "pane_ended_close" => "Close pane",
        "pane_exited" => "exited",
        "pane_exited_code" => "exited with code {code}",
        "pane_exited_signal" => "ended by signal {signal}",
        ...
        "monitor_all_hosts_desc" => "Monitor every host without opting in each one. The per-host toggle in the host editor is locked while this is on.",
        "monitor_dash_live_only" => "Only hosts with a live session",
        "monitor_dash_live_only_desc" => "The Monitoring dashboard shows only hosts a terminal tab is already logged in to, and never opens a connection of its own. Off, it connects to every monitored host.",
