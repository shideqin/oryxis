...
pub(super) fn lookup(key: &str) -> &'static str {
    match key {
        ...
        "sync_passphrase_substituted_hint" => "The passphrase you typed differs from the saved one, so this round used the saved passphrase",
        ...
        "sync_passphrase_edit_placeholder" => "Enter the sync passphrase",
